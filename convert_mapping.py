...
ENGINE_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    "uae_payroll_calc": {
        ...
        "fxPolicy": {
            ...
            "roundDigitsKey": "uaePnFxRoundDigits",
            "defaultBase": 3.6725,
    ...
    "italy_payroll_calc": {
        ...
        "fixedValueWrites": [
            ...
            {
                "id": "italyPnFxRate",
                "valueKey": "italyPnFxBase",
                "sheet": "PN",
                "columnLetter": "B",
                "labelContains": "FX rate",
                "scope": "singleCell",
                "writeAsFormula": True,
                "remark": "Italy 汇率公式 =基准*系数；映射存 italyPnFxBase / italyPnFxAdjustment",
            },
        ],
        "fxPolicy": {
            "mode": "api_as_base",
            "writeFormula": True,
            "baseKey": "italyPnFxBase",
            "adjustmentKey": "italyPnFxAdjustment",
            "roundDigitsKey": "italyPnFxRoundDigits",
            "defaultAdjustment": 0.97,
            "defaultCurrency": "EUR",
    ...
    "india_payroll_calc": {
        ...
        "fixedValueWrites": [
            {
                "id": "indiaPnFxRate",
                "valueKey": "indiaPnFxBase",
                "sheet": "PN",
                "columnLetter": "B",
                "labelContains": "FX rate",
                "scope": "singleCell",
                "writeAsFormula": True,
                "remark": "India 汇率公式 =基准*系数；映射存 indiaPnFxBase / indiaPnFxAdjustment",
            },
        ],
        "fxPolicy": {
            "mode": "api_as_base",
            "writeFormula": True,
            "baseKey": "indiaPnFxBase",
            "adjustmentKey": "indiaPnFxAdjustment",
            "roundDigitsKey": "indiaPnFxRoundDigits",
            "defaultAdjustment": 0.97,
            "defaultCurrency": "INR",
            "useVendorCurrency": True,
            "roundDigits": 2,
